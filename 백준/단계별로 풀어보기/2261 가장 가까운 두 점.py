import sys
sys.stdin=open("2261 가장 가까운 두 점.txt","r")

#https://velog.io/@piopiop/%EB%B0%B1%EC%A4%80-2261-%EA%B0%80%EC%9E%A5-%EA%B0%80%EA%B9%8C%EC%9A%B4-%EB%91%90-%EC%A0%90%ED%8C%8C%EC%9D%B4%EC%8D%AC
